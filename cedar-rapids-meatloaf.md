...
**Yield:** 6 servings &nbsp;|&nbsp; **Active time:** ~20 minutes &nbsp;|&nbsp; **Total time:** ~1 hour 15 minutes (plus rest)
...
1. **Heat oven and soak the oats.** Preheat the oven to **350°F (175°C)**. In a large bowl, stir together the quick oats and milk and let them sit while you prep everything else — the oats soften and absorb the milk, which keeps the loaf moist and tender.
...
6. **Bake.** Bake at **350°F (175°C)** for about **45 minutes**, then brush on the remaining glaze and bake another **10–15 minutes**, until the internal temperature reaches **160°F (71°C)** at the center.

   If your loaf sits low and wide (as it will in a longer or shallower pan), start checking the temperature around **40 minutes** — a thinner loaf cooks faster, so go by the thermometer, not the clock.
...
- The milk-and-oat panade is what separates a tender meatloaf from a dense one: the softened starch traps moisture that would otherwise cook out of the meat.
- Safe internal temperature for a beef-pork blend is **160°F (71°C)**.
...
- Serve alongside the [Midwest Jiffy Cornbread](./midwest-jiffy-cornbread.md).

---

## Storage

Refrigerate leftovers in an airtight container for up to 3–4 days, or freeze sliced portions for up to 3 months. Leftovers make a fantastic meatloaf sandwich, which is about as Midwest as it gets.
